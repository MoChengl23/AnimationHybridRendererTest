Shader "Mesh Animator/Universal Render Pipeline/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "MeshAnimator-URP-LitInput.hlsl"
            #include "MeshAnimator-URP-LitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #pragma vertex MAShadowPassVertex
            #pragma fragment MAShadowPassFragment
			
            #include "../MeshAnimator.hlsl"
            #include "MeshAnimator-URP-LitInput.hlsl"
            #include "MeshAnimator-URP-ShadowCasterPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #pragma fragment MAUniversalFragmentMeta
            ...
            #include "../MeshAnimator.hlsl"
            #include "MeshAnimator-URP-LitInput.hlsl"
            #include "MeshAnimator-URP-LitMetaPass.hlsl"
